...
def main():
    ...
    parser.add_argument('-X0',          nargs=1, required=False, metavar='X0_PARAM',     type=int,   default=[1],     help='IC to each site')
    ...
    parser.add_argument('-noX0Rand',    required=False, action='store_true', default=False, help='generates random initial state Xi')
